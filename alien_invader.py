# Alien Invasion Game by Bjorn Osten
# Pygame engine and graphic, feel free to modify as you fancy smancy 
...
class AlienInvasion:
	...
	def _create_fleet(self):
		...
		# Determine the number of rows of Aliens that fit om the screen.
	...
	def _fire_bullet(self):
		"""Create new bullet and add a bullet to the group"""
	...
	def _update_screen(self):
		...
		#Redraw the screen through all passes of the loop
